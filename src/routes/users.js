...
router.post('/login/', validator.validate('login'), userController.checkTypeOfVerification)
// router.post('/login/', validator.validate('login'), authController.authenticationLogin)
